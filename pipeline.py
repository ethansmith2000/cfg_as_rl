...
class StableDiffusionRLCFGPipeline(StableDiffusionPipeline):
    ...
    def __call__(
        ...
        **kwargs,
        ...
        buf_size = self.unet.special_token.size(1)
        ...
        prompt_embeds_reward = torch.cat([prompt_embeds, self.unet.special_token.expand(prompt_embeds.shape[0], -1, -1)], dim=1)
